...
describe('control-signals', () => {
  ...
  it('detects member imbalance when one user carries 70%+', () => {
    const list: Array<{
      id: string
      category_id: string
      price: number
      ...
      ...Array.from({ length: 8 }, (_, i) => ({
        ...
        price: 10000,
        created_by: 'mario',
        created_at: `2026-04-${String(10 + (i % 10)).padStart(2, '0')}T12:00:00`,
        commitment_id: null,
      })),
      {
        id: 'l1',
  ...
  it('detects potential undetected subscription (repeated amounts)', () => {
    const list: Array<{
      id: string
      category_id: string
      price: number
