...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignBrotPreviewScreen } = require('@/screens/dev/redesign/redesign-brot-preview-screen') as typeof import('@/screens/dev/redesign/redesign-brot-preview-screen')
    return <RedesignBrotPreviewScreen />
  }
