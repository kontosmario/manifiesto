...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignFijosPreviewScreen } = require('@/screens/dev/redesign/redesign-fijos-preview-screen') as typeof import('@/screens/dev/redesign/redesign-fijos-preview-screen')
    return <RedesignFijosPreviewScreen />
  }
