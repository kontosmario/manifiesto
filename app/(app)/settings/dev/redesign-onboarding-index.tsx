...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignOnboardingIndexScreen } = require('@/screens/dev/redesign/redesign-onboarding-index-screen') as typeof import('@/screens/dev/redesign/redesign-onboarding-index-screen')
    return <RedesignOnboardingIndexScreen />
  }
