...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignNotifPreviewScreen } = require('@/screens/dev/redesign/redesign-notif-preview-screen') as typeof import('@/screens/dev/redesign/redesign-notif-preview-screen')
    return <RedesignNotifPreviewScreen />
  }
