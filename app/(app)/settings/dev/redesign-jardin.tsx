...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignJardinPreviewScreen } = require('@/screens/dev/redesign/redesign-jardin-preview-screen') as typeof import('@/screens/dev/redesign/redesign-jardin-preview-screen')
    return <RedesignJardinPreviewScreen />
  }
