...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignNavBarPreviewScreen } = require('@/screens/dev/redesign/redesign-nav-bar-preview-screen') as typeof import('@/screens/dev/redesign/redesign-nav-bar-preview-screen')
    return <RedesignNavBarPreviewScreen />
  }
