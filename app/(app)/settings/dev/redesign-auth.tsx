...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignAuthFlowScreen } = require('@/screens/dev/redesign/redesign-auth-flow-screen') as typeof import('@/screens/dev/redesign/redesign-auth-flow-screen')
    return <RedesignAuthFlowScreen />
  }
