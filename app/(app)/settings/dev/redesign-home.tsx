...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignHomePreviewScreen } = require('@/screens/dev/redesign/redesign-home-preview-screen') as typeof import('@/screens/dev/redesign/redesign-home-preview-screen')
    return <RedesignHomePreviewScreen />
  }
