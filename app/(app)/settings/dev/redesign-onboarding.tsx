...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignOnboardingFlowScreen } = require('@/screens/dev/redesign/redesign-onboarding-flow-screen') as typeof import('@/screens/dev/redesign/redesign-onboarding-flow-screen')
    return <RedesignOnboardingFlowScreen />
  }
