...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignParticlesPreviewScreen } = require('@/screens/dev/redesign/redesign-particles-preview-screen') as typeof import('@/screens/dev/redesign/redesign-particles-preview-screen')
    return <RedesignParticlesPreviewScreen />
  }
