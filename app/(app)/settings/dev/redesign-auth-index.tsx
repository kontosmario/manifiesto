...
export default function Page() {
  if (__DEV__) {
    ...
    const { RedesignAuthIndexScreen } = require('@/screens/dev/redesign/redesign-auth-index-screen') as typeof import('@/screens/dev/redesign/redesign-auth-index-screen')
    return <RedesignAuthIndexScreen />
  }
