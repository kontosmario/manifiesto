-- home_snapshot: incluir families.kind en el slice family, para que el
-- seed del snapshot no clobberee la cache de familia a 'shared' en modo solo.
-- Definición = dump verbatim de prod (pg_get_functiondef) + el campo kind.
