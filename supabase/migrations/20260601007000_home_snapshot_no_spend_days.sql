...
-- existing key identical and adding 2 new keys at the end of both
-- jsonb_build_object branches (populated + no-family fallback).
-- Function signature unchanged (zero args, returns jsonb).
--
