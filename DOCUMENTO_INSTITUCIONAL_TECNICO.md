...
- `join_family_by_code`: incorpora al usuario a una familia existente.
...
El código web heredado fue preservado como referencia histórica, pero no forma parte del build activo del producto actual.
...
- [BRIEF_UI_UX_MANIFIESTO.md](/Users/mario/apps/manifiesto/BRIEF_UI_UX_MANIFIESTO.md): brief de handoff para diseño UI/UX.
- [FLUJOS_Y_FUNCIONAMIENTO_APP.md](/Users/mario/apps/manifiesto/FLUJOS_Y_FUNCIONAMIENTO_APP.md): detalle funcional de journeys, rutas y comportamiento real de la app.
- [BRANDING.md](/Users/mario/apps/manifiesto/BRANDING.md): lineamientos visuales y criterio de identidad.
- [CODE_RULES.md](/Users/mario/apps/manifiesto/CODE_RULES.md): reglas de arquitectura, UX mobile, accesibilidad y calidad de implementación.
