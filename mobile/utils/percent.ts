 ...
 * percentage string. NaN / null / non-finite values render as a
 * localized "no baseline" placeholder (moved here so feature modules
...
export function formatDeltaPercent(value: number | null): string {
  if (value == null || !Number.isFinite(value)) {
    return i18n.t('common:placeholders.noBase')
  }
