...
export const categoryHues: Record<CategoryHueKey, CategoryHue> = {
  ...
  restaurante:   { key: 'restaurante',   light: { surface: '#FCDDD3', ink: '#A0381F' }, dark: { surface: '#3A2420', ink: '#F0A892' } },
  // Supermercado — verde lima
  supermercado:  { key: 'supermercado',  light: { surface: '#E5F0CC', ink: '#3F6018' }, dark: { surface: '#252E1A', ink: '#BCD68A' } },
  ...
  viajes:        { key: 'viajes',        light: { surface: '#D4ECF4', ink: '#1F5C75' }, dark: { surface: '#1A2B33', ink: '#A0CFE0' } },
  ...
  suscripciones: { key: 'suscripciones', light: { surface: '#F2DDEC', ink: '#8A2D6A' }, dark: { surface: '#352130', ink: '#E8A8D0' } },
  ...
  belleza:       { key: 'belleza',       light: { surface: '#F8DDE8', ink: '#9C3A66' }, dark: { surface: '#3A222C', ink: '#F0A8C0' } },
  ...
  deporte:       { key: 'deporte',       light: { surface: '#FCE2C8', ink: '#A04C12' }, dark: { surface: '#3A2A1C', ink: '#F0B888' } },
  // Educación / cursos / libros — índigo
  educacion:     { key: 'educacion',     light: { surface: '#DDDFF0', ink: '#3A3D80' }, dark: { surface: '#222438', ink: '#AAB0E0' } },
  // Tecnología / gadgets — cyan
  tecnologia:    { key: 'tecnologia',    light: { surface: '#D0EDED', ink: '#1F6068', }, dark: { surface: '#1C2D2F', ink: '#9CD2D8' } },
  // Mascotas — teal verde
  mascotas:      { key: 'mascotas',      light: { surface: '#D2EDE0', ink: '#1F6A4E' }, dark: { surface: '#1C302A', ink: '#9CDABA' } },
  ...
  regalos:       { key: 'regalos',       light: { surface: '#F8DCD2', ink: '#8E2F40' }, dark: { surface: '#3A2222', ink: '#F0A8B0' } },
  // Inversiones / plazo fijo / bonos — oro cálido (sugiere crecimiento)
  inversiones:   { key: 'inversiones',   light: { surface: '#F5E6BD', ink: '#7A5A1C' }, dark: { surface: '#36301C', ink: '#E8CC7A' } },
