...
| `fijos-tabs.tsx` | ✅ LIVE | **3 buckets v4** (2026-05-31): Vencidos / Pendientes / Pagados. Color rojo brand-deep para Vencidos. Auto-promote a Vencidos en primer paint si hay vencidos (respeta selección manual). |
...
| **FijosTabs** | ✅ LIVE | Reutiliza GastosFilterPill. **2026-05-31 v4**: **3 buckets** (Vencidos / Pendientes / Pagados). Rojo brand-deep para Vencidos. La tab "Próximos" se eliminó tras descubrir que los `future` items eran <1% del tiempo; pasaron al `FijosScheduledBanner` contextual. Historial: v1 (4 tabs todos/pend/pag/zombis) → v2 (2 tabs, 2026-05-30) → v3 (4 tabs venc/pend/pag/prox, 2026-05-30) → v4 (3 tabs, 2026-05-31). |
