...
- `tests/unit/financial-summary-radial-static.test.ts` — módulo eliminado durante refactor.
- `tests/unit/home-aggregates-{mood,sparkline,streak,hero-stats}.test.ts` — funciones removidas de `home-aggregates.model`.
