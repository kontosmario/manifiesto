...
> **Nota aclaratoria 2026-05-22 (revisión documental):** los paths internos que referencian `docs/PENDIENTES A IMPLEMENTAR/` y `docs/runbooks/` ya **no existen** — esos archivos fueron movidos en la reorg 2026-05-22 a `docs/operaciones/`. Rutas actualizadas:
> - `docs/PENDIENTES A IMPLEMENTAR/security-pendings-2026-05-08.md` → `docs/operaciones/pendientes-seguridad.md`
> - `docs/PENDIENTES A IMPLEMENTAR/push-notifications-ios-setup-2026-05-09.md` → `docs/operaciones/push-notifications-ios-setup.md`
> - `docs/runbooks/backend-hardening.md` → `docs/operaciones/runbook-backend-hardening.md`
> El contenido de este snapshot histórico no se modifica.
